#!/usr/bin/env python3
"""
Monitor de Performance do Ollama/Llama - Versao Windows
Mostra estatisticas em tempo real: tokens, velocidade, requests, etc.
"""
...
class OllamaMonitor:
    ...
    def format_time(self, seconds):
        """Formatar tempo em formato legivel"""
        if seconds < 60:
    ...
    def display_stats(self):
        ...
        print("MONITOR OLLAMA/LLAMA - ESTATISTICAS EM TEMPO REAL")
        print("=" * 60)
        ...
        if ollama_status and "error" not in ollama_status:
            ...
            print("Ollama nao esta respondendo")
        ...
        if "error" not in sys_stats:
            ...
            print(f"Memoria: {sys_stats.get('memory_percent', 0):.1f}% ({sys_stats.get('memory_available_gb', 0):.1f} GB livres)")
        ...
        print(f"Uptime: {self.format_time(uptime)}")
        ...
        print("   - Execute uma analise para ver estatisticas em tempo real")
        print("   - Monitore CPU/Memoria para otimizacao")
        print("=" * 60)
...
def main():
    ...
    try:
        ...
        if response.status_code != 200:
            print("Ollama nao esta rodando ou nao esta acessivel")
